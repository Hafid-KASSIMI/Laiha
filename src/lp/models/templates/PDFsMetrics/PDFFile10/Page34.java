...
public class Page34 extends Page {
    ...
    public Page34() {
        ...
        stuRect.setRow(107.162f, 15.719f);
        stuRect.getNumero().setXW(567.24f, 14.52f);
        stuRect.getSecondName().setXW(417f, 149.762f);
        toAdmin.reset(417f, 776.16f, 164.76f, 30f);
        signature.reset(417f, 736.441f, 164.76f, 38.762f);
