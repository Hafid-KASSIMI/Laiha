...
public class Page2 extends Page {
    ...
    private final float[] ys = { 121.559f, 272.039f, 423.719f };
    private final float[] ws = { 26.398f, 347.758f, 346.078f };
    private final float[] hs = { 149.520f, 150.719f, 150f };
    private final float[] xs = { 794.160f, 372.961f, 24f };
