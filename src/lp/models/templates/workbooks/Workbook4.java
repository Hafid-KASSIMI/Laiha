...
public class Workbook4 extends Workbook123456 {
    ...
    public Workbook4(){
        ...
        gap = "...............................\n";
        gap += gap + gap;
        tpl = tempaltesDir + "Template.4.xlsx";
        firstRow = 5;
    }
    ...
    protected void add1PageGroup(Group g, XSSFSheet sht, int start, int stuCount) {
        ...
        XSSFCellStyle cs;
        XSSFCell xc;
        HorizontalAlignment ha = getAlignment(Settings.PREF_TEMPORARY.get("TPL4_NAMES_ALIGN"));
        ...
        sht.getRow(cr.getRow()).getCell(cr.getCol(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.PREF_TEMPORARY.get("TPL4_TITLE"));
        cr = new CellReference(customStr);
        sht.getRow(cr.getRow()).getCell(cr.getCol(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.PREF_TEMPORARY.get("TPL4_CUSTOM_STRING"));
