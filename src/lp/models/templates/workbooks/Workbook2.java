...
public class Workbook2 extends Workbook123456 {
    private final String schoolName, customStr;
    ...
    public Workbook2(){
        ...
        fir = "D";
        customStr = "E4";
        tpl = tempaltesDir + "Template.2.xlsx";
        firstRow = 5;
    }
    ...
    protected void add1PageGroup(Group g, XSSFSheet sht, int start, int stuCount) {
        ...
        XSSFCellStyle cs;
        XSSFCell xc;
        HorizontalAlignment ha = getAlignment(Settings.PREF_TEMPORARY.get("TPL2_NAMES_ALIGN"));
        ...
        cr = new CellReference(schoolName);
        sht.getRow(cr.getRow()).getCell(cr.getCol(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.SCHOOL_DB.getSchool());
        ...
        sht.getRow(cr.getRow()).getCell(cr.getCol(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.PREF_TEMPORARY.get("TPL2_TITLE"));
        cr = new CellReference(customStr);
        sht.getRow(cr.getRow()).getCell(cr.getCol(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.PREF_TEMPORARY.get("TPL2_CUSTOM_STRING"));
